(function () {
    ...
    $('#formAddUsuario').on('submit', function (event) {
        ...
        const formData = new FormData($('#formAddUsuario')[0]);
        const form2 = new FormData($('#formAddDatosPersonales')[0]);
        ...
        const form2Obj = formDataToObject(form2);

        // Combinar los objetos de datos en un solo objeto
        const dataForms = {
            datos_personales: form2Obj,
            usser: formDataObj
        };
